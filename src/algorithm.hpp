                        ...
                        InputIt2 last2)
{
    ...
    /* if first range is a prefix of the second, then the first it is
     * lexigraphically less than the second. */
                        ...
                        Compare cmp)
{
    ...
    while (it1 != last1 && it2 != last2) {
        /* in case *it1 == *it2, the two calls to cmp should return false so
