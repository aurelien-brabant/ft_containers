...
int test_lc_first1_less_than_first2(Tester& tester)
{
	...
	bool ret = FT_CONTAINER::lexicographical_compare(r1, r1 + sizeof(r1) / sizeof(int), r2, r2 + sizeof(r2) / sizeof(int));
...
int test_lc_first1_empty(Tester& tester)
{
	...
	bool ret = FT_CONTAINER::lexicographical_compare(r1, r1, r2, r2 + sizeof(r2) / sizeof(int));
...
int test_lc_first2_empty(Tester& tester)
{
	...
	bool ret = FT_CONTAINER::lexicographical_compare(r1, r1 + sizeof(r1) / sizeof(int), r2, r2);
...
int test_lc_perf_differ_at_last_element(Tester& tester)
{
	...
	bool ret = FT_CONTAINER::lexicographical_compare(v1.begin(), v1.end(), v2.begin(), v2.end()) == true;
